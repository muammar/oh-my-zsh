...
```shell
sh -c "$(curl -fsSL https://raw.github.com/gerardo/oh-my-zsh/master/tools/install.sh)"
```

#### via wget

```shell
sh -c "$(wget https://raw.github.com/gerardo/oh-my-zsh/master/tools/install.sh -O -)"
```
