...
@curl -L https://github.com/gerardo/oh-my-zsh/raw/master/tools/install.sh | sh@

h4. via `wget`

@wget --no-check-certificate https://raw.github.com/gerardo/oh-my-zsh/raw/master/tools/install.sh -O - | sh@
...
1. Clone the repository
  ...
  @git clone git://github.com/gerardo/oh-my-zsh.git ~/.oh-my-zsh@
